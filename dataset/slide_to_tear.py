...
class SlideToTear:
    ...
    def __init__(self, injector: Injector, config: ConfigBlock):
        ...
        self.START_POS_UP = [-0.468, -0.556 + self.load_dy * 0.001, -0.007]
        self.START_POS_DOWN = [-0.448, -0.556 + self.load_dy * 0.001, -0.005 + self.load_dz * 0.001]
        self.END_POS_DOWN = [-0.428, -0.556 + self.load_dy * 0.001, -0.005 + self.load_dz * 0.001]
        self.END_POS_UP = [-0.408, -0.556 + self.load_dy * 0.001, -0.007]
...
def run(**kwargs):
    Platform.create(shared_config(SlideToTear, 'sim', **kwargs)).run()
